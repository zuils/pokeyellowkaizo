...
; Characteristics of each move.
	...
	move FIRE_PUNCH,   BURN_SIDE_EFFECT1,           80, FIRE,         100, 15
	move ICE_PUNCH,    FREEZE_SIDE_EFFECT,          80, ICE,          100, 15
	move THUNDERPUNCH, PARALYZE_SIDE_EFFECT1,       80, ELECTRIC,     100, 15
	move SCRATCH,      NO_ADDITIONAL_EFFECT,        40, NORMAL,       100, 35
	move VICEGRIP,     NO_ADDITIONAL_EFFECT,        55, NORMAL,       100, 30
	move GUILLOTINE,   OHKO_EFFECT,                  1, NORMAL,        30,  1
	move RAZOR_WIND,   FLINCH_SIDE_EFFECT2,        120, NORMAL,       100,  5
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, NORMAL,       100,  1
	move CUT,          NO_ADDITIONAL_EFFECT,        50, NORMAL,        95, 30
	move GUST,         NO_ADDITIONAL_EFFECT,        40, NORMAL,       100, 35
	move WING_ATTACK,  NO_ADDITIONAL_EFFECT,        50, FLYING,       100, 35
	...
	move SLAM,         NO_ADDITIONAL_EFFECT,        70, NORMAL,       100, 20
	...
	move SAND_ATTACK,  ACCURACY_DOWN1_EFFECT,        0, NORMAL,       100,  3
	...
	move HYDRO_PUMP,   NO_ADDITIONAL_EFFECT,       120, WATER,         85,  8
	move SURF,         NO_ADDITIONAL_EFFECT,        95, WATER,        100, 15
	move ICE_BEAM,     FREEZE_SIDE_EFFECT,          95, ICE,          100, 10
	move BLIZZARD,     FREEZE_SIDE_EFFECT,         120, ICE,           85,  8
	move PSYBEAM,      CONFUSION_SIDE_EFFECT,       65, PSYCHIC_TYPE, 100, 20
	move BUBBLEBEAM,   SPEED_DOWN_SIDE_EFFECT,      65, WATER,        100, 20
	move AURORA_BEAM,  ATTACK_DOWN_SIDE_EFFECT,     65, ICE,          100, 20
	move HYPER_BEAM,   HYPER_BEAM_EFFECT,          150, NORMAL,        90,  5
	move PECK,         NO_ADDITIONAL_EFFECT,        50, FLYING,       100, 35
	...
	move LEECH_SEED,   LEECH_SEED_EFFECT,            0, GRASS,         90,  3
	move GROWTH,       SPECIAL_UP1_EFFECT,           0, NORMAL,       100,  3
	move RAZOR_LEAF,   NO_ADDITIONAL_EFFECT,        55, GRASS,         95, 25
	move SOLARBEAM,    NO_ADDITIONAL_EFFECT,       120, GRASS,        100,  5
	move POISONPOWDER, POISON_EFFECT,                0, POISON,        75, 35
	move STUN_SPORE,   PARALYZE_EFFECT,              0, GRASS,         75, 30
	move SLEEP_POWDER, SLEEP_EFFECT,                 0, GRASS,         75, 15
	move PETAL_DANCE,  CONFUSION_SIDE_EFFECT,      100, GRASS,        100, 20
	move STRING_SHOT,  SPEED_DOWN1_EFFECT,           0, BUG,           95,  2
	...
	move MEDITATE,     ATTACK_UP1_EFFECT,            0, PSYCHIC_TYPE, 100,  3
	move AGILITY,      SPEED_UP2_EFFECT,             0, PSYCHIC_TYPE, 100,  1
	...
	move SCREECH,      DEFENSE_DOWN2_EFFECT,         0, NORMAL,        85,  1
	move DOUBLE_TEAM,  EVASION_UP1_EFFECT,           0, NORMAL,       100,  1
	move RECOVER,      HEAL_EFFECT,                  0, NORMAL,       100, 20
	move HARDEN,       DEFENSE_UP1_EFFECT,           0, NORMAL,       100,  3
	move MINIMIZE,     EVASION_UP1_EFFECT,           0, NORMAL,       100,  1
	move SMOKESCREEN,  ACCURACY_DOWN1_EFFECT,        0, NORMAL,       100,  3
	move CONFUSE_RAY,  CONFUSION_EFFECT,             0, GHOST,        100, 10
	move WITHDRAW,     DEFENSE_UP1_EFFECT,           0, WATER,        100,  3
	move DEFENSE_CURL, DEFENSE_UP1_EFFECT,           0, NORMAL,       100,  3
	move BARRIER,      DEFENSE_UP2_EFFECT,           0, PSYCHIC_TYPE, 100,  3
	move LIGHT_SCREEN, LIGHT_SCREEN_EFFECT,          0, PSYCHIC_TYPE, 100,  3
	...
	move SKY_ATTACK,   FLINCH_SIDE_EFFECT2,        120, FLYING,       100,  5
	move TRANSFORM,    TRANSFORM_EFFECT,             0, NORMAL,       100, 10
	move BUBBLE,       SPEED_DOWN_SIDE_EFFECT,      20, WATER,        100, 30
	move DIZZY_PUNCH,  NO_ADDITIONAL_EFFECT,        70, NORMAL,       100, 10
	move SPORE,        SLEEP_EFFECT,                 0, GRASS,        100, 15
	move FLASH,        ACCURACY_DOWN1_EFFECT,        0, NORMAL,        90,  3
	move PSYWAVE,      SPECIAL_DAMAGE_EFFECT,        1, PSYCHIC_TYPE,  80, 15
	move SPLASH,       SPLASH_EFFECT,                0, NORMAL,       100, 40
	move ACID_ARMOR,   DEFENSE_UP2_EFFECT,           0, POISON,       100,  1
	move CRABHAMMER,   NO_ADDITIONAL_EFFECT,       120, WATER,         95, 10
	...
	move SHARPEN,      ATTACK_UP1_EFFECT,            0, NORMAL,       100,  2
